<?php
/**
 * sebastienvelly functions and definitions
 *
...
if ( ! function_exists( 'sebastienvelly_setup' ) ) :
	/**
	 ...
	 */
	function sebastienvelly_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on sebastienvelly, use a find and replace
		 * to change 'sebastienvelly' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'sebastienvelly', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'sebastienvelly' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'sebastienvelly_custom_background_args', array(
...
add_action( 'after_setup_theme', 'sebastienvelly_setup' );
 ...
 */
function sebastienvelly_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'sebastienvelly_content_width', 640 );
}
add_action( 'after_setup_theme', 'sebastienvelly_content_width', 0 );
 ...
 */
function sebastienvelly_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'sebastienvelly' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'sebastienvelly' ),
...
add_action( 'widgets_init', 'sebastienvelly_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function sebastienvelly_scripts() {
...
add_action( 'wp_enqueue_scripts', 'sebastienvelly_scripts' );
